    ...
    <div className="mt-5">
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-5 '>
            {businessList.length>0 ?  businessList.map((business,index)=>(
                <Link href={'/details/'+business.id} key={index} className="shadow-md rounded-lg hover:shadow-lg cursor-pointer
                 hover:shadow-primary hover:scale-105 transition-all erase-in-out">
            ...
            <div className="w-full h-[200px] bg-slate-200 rounded-lg  animate-pulse" key={index}>
